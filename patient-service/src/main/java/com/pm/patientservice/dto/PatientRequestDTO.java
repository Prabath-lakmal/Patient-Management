...
public class PatientRequestDTO {
    ...
    public @NotBlank @Size(max = 100, message = "Name cannot exceed 100 characters")
    ...
    public void setRegisteredDate(@NotBlank(message = "Registerd date is required") String registeredDate) {
